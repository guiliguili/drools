...
public abstract class ProjectClassLoader extends ClassLoader implements KieTypeResolver, StoreClassLoader, WritableClassLoader {
	...
	{
		// the property is set during the drools startup in OnTenantStartupProcessor
		final String[] excludedPatterns = System.getProperty("drools.projectclassloader.excludedpatterns", "_query,_test_")
				.split(",", 100);
